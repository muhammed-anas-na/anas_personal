...
import { XhrIo as _, EventType as k, ErrorCode as A, createWebChannelTransport as D, getStatEventTarget as N, FetchXmlHttpFactory as C, WebChannel as x, Event as R, Stat as L } from "@firebase/webchannel-wrapper";
...
function U(t) {
    ...
    if (M.logLevel <= f.DEBUG) {
        var i = n.map(K);
        M.debug.apply(M, e([ "Firestore (" + F + "): " + t ], i));
    }
}

function B(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (M.logLevel <= f.ERROR) {
        var i = n.map(K);
        M.error.apply(M, e([ "Firestore (" + F + "): " + t ], i));
    }
}
 ...
 */ function j(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (M.logLevel <= f.WARN) {
        var i = n.map(K);
        M.warn.apply(M, e([ "Firestore (" + F + "): " + t ], i));
    }
}
 ...
 */ var H = {
    ...
    return t.prototype.start = function(t, e) {
        ...
        this.o = function() {
            i.i++, i.currentUser = i.u(), a.resolve(), a = new J, t.enqueueRetryable((function() {
        ...
        setTimeout((function() {
            if (!i.auth) {
                ...
                U("FirebaseAuthCredentialsProvider", "Auth not yet detected"), a.resolve(), a = new J);
            }
        }), 0), u();
...
var ut = /** @class */ function() {
    ...
    return t.A = function() {
        ...
        ; n.length < 20; ) for (var r = at(40), i = 0; i < r.length; ++i) 
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            ...
            if ("\\" === a) {
                ...
                var u = t[i + 1];
                if ("\\" !== u && "." !== u && "`" !== u) throw new Y(H.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += u, i += 2;
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Ft(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return ht(t.arrayValue.values || [], e.arrayValue.values || [], Ft);
...
function Vt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = ct(kt(t.latitude), kt(e.latitude));
            return 0 !== n ? n : ct(kt(t.longitude), kt(e.longitude));
...
var re = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.P(t, e, r) : new ie(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new ue(t, r) : "in" /* IN */ === e ? new ce(t, r) : "not-in" /* NOT_IN */ === e ? new he(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new fe(t, r) : new n(t, e, r);
    }, n.P = function(t, e, n) {
...
/** Filter that matches on key fields within an array. */ function ae(t, e) {
    var n;
...
/** Creates a new Query instance with the options provided. */ function we(t, e, n, r, i, o, s, a) {
    return new ge(t, e, n, r, i, o, s, a);
}
 ...
 */ function Ae(t) {
    var e = W(t);
    if (!e.D) if ("F" /* First */ === e.limitType) e.D = $t(e.path, e.collectionGroup, ke(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = ke(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new pe(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var a = e.endAt ? new le(e.endAt.position, !e.endAt.before) : null, u = e.startAt ? new le(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.D = $t(e.path, e.collectionGroup, n, e.filters, e.limit, a, u);
    }
    return e.D;
}
...
function Ne(t, e) {
    return ee(Ae(t), Ae(e)) && t.limitType === e.limitType;
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function Re(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !ve(t.startAt, ke(t), e)) && (!t.endAt || !ve(t.endAt, ke(t), e));
    }(t, e);
}

function Le(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = ke(t); i < o.length; i++) {
            var s = o[i], a = Pe(s, e, n);
            if (0 !== a) return a;
 ...
 */ function qe(t, e, n) {
    return t instanceof je ? function(t, e) {
        ...
        return Kt(n) && Kt(t.N) ? Fe(r) : Oe(t.k, r);
    }(t, e);
}
 ...
 */ function rn(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), a = Be(o.transform, s || null);
        null != a && (null == n && (n = Yt.empty()), n.set(o.field, a));
    }
    return n || null;
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && ht(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Ke && e instanceof Ke || t instanceof ze && e instanceof ze ? ht(t.elements, e.elements, Ft) : t instanceof We && e instanceof We ? Ft(t.N, e.N) : t instanceof je && e instanceof je;
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.ot = function(t) {
        for (var e = 0, n = t.$; e < n.length; e++) {
            var r = n[e];
            t.O && t.O.isFoundDocument() ? this.at(r, t.O) : this.ct(r, t.key, t.O);
        }
    ...
    t.prototype.dt = function(t) {
        var e = t.targetId, n = t.F.count, r = this.wt(e);
        if (r) {
            var i = r.target;
            if (ne(i)) if (0 === n) {
                ...
                // queries.
                var o = new Pt(i.path);
                this.ct(e, o, Xt.newNoDocument(o, dt.min()));
        ...
        this.nt.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && ne(o.target)) {
                    ...
                    null !== e.st.get(s) || e.yt(i, s) || e.ct(i, s, Xt.newNoDocument(s, t));
                }
                r.j && (n.set(i, r.G()), r.H());
            }
        }));
...
function or(t, e, n) {
    var r = $n(t, e.name), i = Yn(e.updateTime), o = new Yt({
        mapValue: {
            fields: e.fields
        }
...
function ar(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Ze.updateTime(Yn(t.updateTime)) : void 0 !== t.exists ? Ze.exists(t.exists) : Ze.none();
    }(e.currentDocument) : Ze.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
    ...
    if (e.update) {
        e.update.name;
        var i = $n(t, e.update.name), o = new Yt({
            mapValue: {
...
function hr(t) {
    ...
    var h = null;
    return n.endAt && (h = dr(n.endAt)), we(e, i, a, s, u, "F" /* First */ , c, h);
}
 ...
 */ Mr.key = "targetGlobalKey", Mr.store = "targetGlobal";
...
// Visible for testing
var jr = e(e([], e(e([], e(e([], e(e([], [ Dr.store, Nr.store, Cr.store, Lr.store, Or.store, Ar.store, Mr.store, Fr.store ]), [ qr.store ])), [ Pr.store ])), [ Vr.store ])), [ Ur.store, Br.store ]), Kr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Gr = /** @class */ function() {
    function t() {
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return U("SimpleDb", "Removing database:", t), Zr(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return u.db = r.sent(), e = Qr.open(u.db, t, n ? "readonly" : "readwrite", i), a = o(e).catch((function(t) {
 ...
 */ var Xr = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return U("SimpleDb", "ADD", this.store.name, t, t), Zr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return Zr(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), U("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return U("SimpleDb", "DELETE", this.store.name, t), Zr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return U("SimpleDb", "COUNT", this.store.name), Zr(this.store.count());
...
/** Encodes a document for storage locally. */ function ui(t, e, n) {
    ...
    if (e.isNoDocument()) {
        var a = e.key.path.toArray(), u = fi(e.version), c = e.hasCommittedMutations;
        return new Lr(
        /* unknownDocument= */ null, new xr(a, u), 
        /* document= */ null, c, r, i);
    }
...
/** Decodes a DbMutationBatch into a MutationBatch */ function di(t, e) {
    ...
    var s = e.mutations.map((function(e) {
        return ar(t.Gt, e);
    })), a = lt.fromMillis(e.localWriteTimeMs);
    return new ri(e.batchId, a, n, s);
}
...
/** Decodes a DbTarget into TargetData */ function pi(t) {
    ...
    e = Ae(be(er(n.documents[0])))) : e = function(t) {
        return Ae(hr(t));
...
function yi(t, e) {
    ...
    n = ne(e.target) ? ur(t.Gt, e.target) : cr(t.Gt, e.target);
 ...
 */
function ki(t, e, n) {
    var r = t.store(Nr.store), i = t.store(Cr.store), o = [], s = IDBKeyRange.only(n.batchId), a = 0, u = r.jt({
        range: s
    }, (function(t, e, n) {
        return a++, n.delete();
    }));
...
var Di = /** @class */ function() {
    ...
    return t.Xt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(a) {
            z("number" == typeof a);
            for (var u = new ri(a, e, n, r), c = function(t, e, n) {
            ...
            }(i.k, i.userId, u), h = [], f = new Tn((function(t, e) {
                return ct(t.canonicalString(), e.canonicalString());
            })), l = 0, d = r; l < d.length; l++) {
                var p = d[l], y = Cr.key(i.userId, p.key.path, a);
    ...
    t.prototype.Zt = function(t, e) {
        ...
        return e.forEach((function(e) {
            var o = Cr.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), a = xi(t).jt({
                range: s
            }, (function(t, i, o) {
                var s = t[0], a = t[1], u = t[2], c = _r(a);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
        ...
        var n = this, r = e.path, i = r.length + 1, o = Cr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), a = new Tn(ct);
        return xi(t).jt({
            range: s
        }, (function(t, e, o) {
            var s = t[0], u = t[1], c = t[2], h = _r(u);
        ...
        var n = this;
        return ki(t.Wt, this.userId, e).next((function(r) {
 ...
 */ var Li = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            ...
            return z(e.targetCount > 0), e.targetCount -= 1, n.ae(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.ue = function(t, e) {
        ...
        var n = Mi(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
 ...
 */ var Ui = /** @class */ function() {
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return u = Date.now(), V() <= f.DEBUG && U("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (a - s) + "ms\n\tRemoved " + t + " documents in " + (u - a) + "ms\nTotal Duration: " + (u - h) + "ms"), 
            zr.resolve({
                didRun: !0,
            ...
            if (a <= e) {
                var u = n.Ae(t, s).next((function(e) {
                    ...
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s), Mi(t).delete([ 0, Tr(s.path) ]);
                    }));
                }));
                i.push(u);
            }
 ...
 */ var zi = /** @class */ function() {
    ...
    t.prototype.Ve = function(t, e) {
        ...
        return this.ve(t, e, (function(t, e) {
            var o = n.be(t, e);
            r = r.insert(t, o), i = i.insert(t, Ai(e));
        })).next((function() {
            return {
                documents: r,
                Se: i
        ...
        return Ji(t).jt(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var a = ai(r.k, n);
                e.path.isPrefixOf(a.key.path) ? Re(e, a) && (i = i.insert(a.key, a)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        ...
        return this.changes.forEach((function(o, s) {
            ...
            if (s.document.isValidDocument()) {
                var u = ui(e.De.k, s.document, e.getReadTime(o));
                ...
                var h = ui(e.De.k, Xt.newNoDocument(o, dt.min()), e.getReadTime(o));
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Zi = /** @class */ function() {
    function t(t) {
        this.k = t;
    }
    /**
     ...
     */    return t.prototype.Nt = function(t, e, n, r) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(Fr.store), t.deleteObjectStore(Or.store), t.deleteObjectStore(Mr.store);
     ...
     */
            return function(t) {
                var e = t.store(Mr.store), n = new Mr(
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, dt.min().toTimestamp(), 
                /*targetCount=*/ 0);
                return e.put(Mr.key, n);
            }(o);
        }))), n < 4 && r >= 4 && (0 !== n && (
    ...
    t.prototype.xe = function(t) {
        var e = t.store(Fr.store), n = t.store(Lr.store);
        return t.store(Mr.store).get(Mr.key).next((function(t) {
            var r = [];
            return n.jt((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? zr.resolve() : function(n) {
                        return e.put(new Fr(0, Tr(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return zr.waitFor(r);
...
var to = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", eo = /** @class */ function() {
    ...
    h) {
        ...
        this.Fe = o, this.window = s, this.document = a, this.Me = c, this.Le = h, this.Be = null, 
        ...
        this.referenceDelegate = new Ki(this, i), this.Ge = n + "main", this.k = new si(u), 
        this.ze = new Wr(this.Ge, 11, new Zi(this.k)), this.He = new Pi(this.referenceDelegate, this.k), 
    ...
    t.prototype.Ze = function() {
        ...
        var e = this;
        return no(t).get(Ar.key).next((function(t) {
    ...
    t.prototype.nn = function() {
        var t = this;
        this.je = this.Fe.enqueueAfterDelay("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, (function() {
    ...
    t.prototype.on = function(t) {
        var e = this;
        return this.Le ? zr.resolve(!0) : no(t).get(Ar.key).next((function(n) {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.yn(), [ 4 /*yield*/ , this.ze.runTransaction("shutdown", "readwrite", [ Ar.store, qr.store ], (function(e) {
                        var n = new ei(e, st.I);
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.an = function(t) {
        ...
        return n.get(Ar.key).next((function(t) {
            return e.un(t) ? (U("IndexedDbPersistence", "Releasing primary lease."), n.delete(Ar.key)) : zr.resolve();
        }));
    }, 
    ...
    t.prototype.en = function() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.qe = function() {
            ...
            e.Fe.enterRestrictedMode(/* purgeExistingTasks= */ !0), e.Fe.enqueueAndForget((function() {
                return e.shutdown();
            }));
 ...
 */
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Nn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, a = o.mutations; s < a.length; s++) {
                    ...
                    h = Xt.newInvalidDocument(c), r = r.insert(c, h)), nn(u, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
        ...
        for (var r = xn(), i = 0, o = e; i < o.length; i++) for (var s = 0, a = o[i].mutations; s < a.length; s++) {
            var u = a[s];
            u instanceof un && null === n.get(u.key) && (r = r.add(u.key));
        }
        var c = n;
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        }(e) || n.isEqual(dt.min()) ? this.Mn(t, e) : this.Fn.vn(t, r).next((function(o) {
            var s = i.Ln(e, o);
            return (Ie(e) || Te(e)) && i.Bn(e.limitType, s, r, n) ? i.Mn(t, e) : (V() <= f.DEBUG && U("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), xe(e)), 
            i.Fn.getDocumentsMatchingQuery(t, e, n).next((function(t) {
    ...
    t.prototype.Bn = function(t, e, n, r) {
        ...
        this.Fn.getDocumentsMatchingQuery(t, e, dt.min());
    }, t;
}(), co = /** @class */ function() {
    function t(
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, s) {
            ...
            o = o.insert(n, s)) : U("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", a.version, " Watch version:", s.version);
        })), o;
    }))
    /**
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 4:
                if (!Jr(a = r.sent())) throw a;
                // All `releaseTarget` does is record the final metadata state for the
                // target, but we've been recording this periodically during target
                // activity. If we lose this write this could cause a very slight
                // difference in the order of target deletion during GC, but we
                // don't define exact LRU semantics so this is acceptable.
                                return U("LocalStore", "Failed to update sequence numbers for target " + e + ": " + a), 
                [ 3 /*break*/ , 5 ];
...
function To(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = _n(), o = ci(n), s = Ji(e), a = IDBKeyRange.lowerBound(o, !0);
            return s.jt({
 ...
 */ function So(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = W(t), s = xn(), a = _n(), u = Nn(), c = 0, h = i; c < h.length; c++) f = h[c], 
                ...
                return d = n.Qn.newChangeBuffer({
                    ...
                    return Ae(be(gt.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return vo(t, d, a, dt.min(), u).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
 ...
 */ function _o(t, e, i) {
    return void 0 === i && (i = xn()), n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , go(t, Ae(vi(e.bundledQuery))) ];
 ...
 */ var ko = /** @class */ function() {
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        for (var s = 0, a = r; s < a.length; s++) {
            var u = a[s];
            this.ws = this.ws.add(new Do(u.key, i)), this.Jt.addToCollectionParentIndex(t, u.key.path.popLast());
        }
        return zr.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
    ...
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.Rs = new Ao, this.targetCount = 0, this.bs = Li.ie();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return this.ce(e), this.targetCount += 1, zr.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.ce(e), zr.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
    ...
    function t(t, e) {
        ...
        }(this.Jt), this.k = new si(e), this.Ye = new ko(this.k);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function Mo(t, e, n) {
...
var qo = /** @class */ function() {
    ...
    function t(t, e, n, r, i) {
        this.window = t, this.Fe = e, this.persistenceKey = n, this.Bs = r, this.syncEngine = null, 
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Qs = Fo(this.persistenceKey, this.Bs), 
        this.Ws = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.Pt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.Bs && (o = this.getItem(Fo(this.persistenceKey, i))) && (s = Bo.Os(i, o)) && (this.Ks = this.Ks.insert(s.clientId, s));
                    ...
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.Gs.test(i.key)) {
                                ...
                                return e;
                            }(i.newValue), a !== st.I && this.sequenceNumberHandler(a); else if (i.key === this.Ys) return [ 2 /*return*/ , this.syncEngine._i() ];
                        } else this.js.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new qo(this.currentUser, t, e, n), i = Mo(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Fs());
    }, t.prototype.si = function(t) {
        var e = Mo(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
    ...
    return t(n, e), n.prototype.Ki = function(t, e, n, r) {
        return new Promise((function(i, o) {
            var s = new _;
            s.listenOnce(k.COMPLETE, (function() {
                try {
        ...
        var r = [ this.Mi, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = D(), o = N(), s = {
        ...
        var a = r.join("");
        U("Connection", "Creating WebChannel: " + a, s);
        var u = i.createWebChannel(a, s), c = !1, h = !1, f = new Yo({
            Vi: function(t) {
                h ? U("Connection", "Not sending because WebChannel is closed:", t) : (c || (U("Connection", "Opening WebChannel transport."), 
                u.open(), c = !0), U("Connection", "WebChannel sending:", t), u.send(t));
            },
            Si: function() {
                return u.close();
            }
 ...
 */
                ...
                } else U("Connection", "WebChannel received:", n), f.Fi(n);
            }
 ...
 */ var ts = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.Fe = t, this.timerId = e, this.Wi = n, this.Gi = r, this.zi = i, this.Hi = 0, 
        this.Ji = null, 
    ...
    function t(t, e, n, r, i, o, s, a) {
        this.Fe = t, this.nr = n, this.sr = r, this.ir = i, this.authCredentialsProvider = o, 
        ...
        /**
             ...
             * close.
             */
        this.rr = 0, this.ar = null, this.cr = null, this.stream = null, this.ur = new ts(t, e)
        /**
    ...
    t.prototype.Tr = function() {}, t.prototype.auth = function() {
        ...
        this.stream = this.Rr(t, e), this.stream.Di((function() {
            r((function() {
                return n.state = 2 /* Open */ , n.cr = n.Fe.enqueueAfterDelay(n.sr, 1e4, (function() {
    ...
    return t.prototype.Br = function() {
        var t = this;
        0 === this.Fr && (this.Ur("Unknown" /* Unknown */), this.Mr = this.asyncQueue.enqueueAfterDelay("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).Gr.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , us(e) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(u) {
            switch (u.label) {
              ...
              case 3:
                return o = u.sent(), U("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), o), 
                [ 4 /*yield*/ , bs(t, o) ];
              ...
              case 6:
                if (e instanceof Fn ? t.Yr.ot(e) : e instanceof Mn ? t.Yr.dt(e) : t.Yr.ut(e), i.isEqual(dt.min())) return [ 3 /*break*/ , 13 ];
                u.label = 7;

              case 7:
                return u.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , po(t.localStore) ];
              ...
              case 11:
                return U("RemoteStore", "Failed to raise snapshot:", a = u.sent()), [ 4 /*yield*/ , bs(t, a) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Gr.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , us(t) ];
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Gr.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , as(t) ];
 ...
 */ function Ns(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), e ? (n.Gr.delete(2 /* IsSecondary */), [ 4 /*yield*/ , as(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return e ? [ 3 /*break*/ , 4 ] : (n.Gr.add(2 /* IsSecondary */), [ 4 /*yield*/ , us(n) ]);
 ...
 */ var Ps = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = An(), this.sortedSet = new wn(this.comparator)
        /**
 ...
 */ function qs(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = W(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new Ms), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 3:
                return u = r.sent(), c = Ls(u, "Initialization of query '" + xe(e.query) + "' failed"), 
...
function Us(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, s, a;
        return r(this, (function(r) {
            return n = W(t), i = e.query, o = !1, (s = n.queries.get(i)) && (a = s.listeners.indexOf(e)) >= 0 && (s.listeners.splice(a, 1), 
 ...
 */ var Gs = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.ro = function(t) {
        ...
        t = Fs.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.co = !0, 
        this.ao.next(t);
    }, t;
}(), zs = /** @class */ function() {
    function t(t, 
 ...
 */ var Ys = function(t) {
    ...
    t.prototype.Po = function(t, e) {
        var n = this, r = e ? e.vo : new Os, i = e ? e.Ro : this.Ro, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, a = !1, u = Ie(this.query) && i.size === this.query.limit ? i.last() : null, c = Te(this.query) && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.Eo = a, 0 !== o.length || u ? {
            snapshot: new Fs(this.query, t.Ro, i, o, t.mutatedKeys, 0 /* Local */ === a, u, 
            /* excludesMetadataChanges= */ !1),
            Co: s
        } : {
            Co: s
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.Oo = {}, this.Fo = new zi((function(t) {
            return Ce(t);
        }), Ne), this.Mo = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Uo = new Map, this.qo = new Ao, 
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , go(n.localStore, Ae(e)) ];

              case 2:
                return a = r.sent(), u = n.sharedClientState.addLocalQueryTarget(a.targetId), i = a.targetId, 
                [ 4 /*yield*/ , na(n, e, i, "current" === u) ];

              case 3:
                o = r.sent(), n.isPrimaryClient && cs(n.remoteStore, a), r.label = 4;
        ...
        return r(this, (function(l) {
            switch (l.label) {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (ya(t, e.targetId, a.Co), 
                                    a.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                ...
                [ 2 /*return*/ , (t.Fo.set(e, f), t.Mo.has(i) ? t.Mo.get(i).push(e) : t.Mo.set(i, [ e ]), 
                h.snapshot) ];
            }
        }));
    }));
...
/** Stops listening to the query. */ function ra(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), i = n.Fo.get(e), (o = n.Mo.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.Mo.set(i.targetId, o.filter((function(t) {
                    return !Ne(t, e);
                }))), void n.Fo.delete(e)) ] : n.isPrimaryClient ? (
              ...
              case 3:
                return da(n, i.targetId), [ 4 /*yield*/ , wo(n.localStore, i.targetId, 
        ...
        return r(this, (function(r) {
            switch (r.label) {
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Wn.vn(t, o).next((function(o) {
                            ...
                            var s = [], a = 0, u = e; a < u.length; a++) {
                                var c = u[a], h = rn(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new un(c.key, h, Jt(h.value.mapValue), Ze.exists(!0)));
                            }
              ...
              case 2:
                ...
                }(n, o.batchId, i), [ 4 /*yield*/ , ga(n, o.changes) ];
              ...
              case 5:
                return s = r.sent(), a = Ls(s, "Failed to persist write"), i.reject(a), [ 3 /*break*/ , 6 ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                (s = o && o.key) ? (a = (a = new wn(Pt.comparator)).insert(s, Xt.newNoDocument(s, dt.min())), 
                u = xn().add(s), c = new Pn(dt.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Tn(ct), a, u), [ 4 /*yield*/ , oa(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.Bo = n.Bo.remove(s), n.Uo.delete(e), ma(n), [ 3 /*break*/ , 4 ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                la(n, i, /*error=*/ null), fa(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , ga(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                // listen events.
                la(n, e, i), fa(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , ga(n, o) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                return s = r.sent(), a = Ls(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function pa(t, e) {
    ...
    var n = t.Bo.get(e);
    null !== n && (hs(t.remoteStore, n), t.Bo = t.Bo.remove(e), t.Uo.delete(n), ma(t));
}

function ya(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Ys ? (t.qo.addReference(o.key, e), va(t, o)) : o instanceof Js ? (U("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function ma(t) {
    for (;t.Lo.size > 0 && t.Bo.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Uo.set(r, new $s(n)), t.Bo = t.Bo.insert(n, r), cs(t.remoteStore, new oi(Ae(be(n.path)), r, 2 /* LimboResolution */ , st.I));
    }
}
...
function ga(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = W(t), s = [], a = [], u = [], o.Fo.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.Fo.forEach((function(t, n) {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                ...
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , ga(n, i.Gn) ];
...
function ba(t, e) {
    ...
    var i = xn(), o = n.Mo.get(e);
    if (!o) return i;
    for (var s = 0, a = o; s < a.length; s++) {
        var u = a[s], c = n.Fo.get(u);
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return i = r.sent(), o = e.view.ko(i), [ 2 /*return*/ , (n.isPrimaryClient && ya(n, e.targetId, o.Co), 
                o) ];
            }
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                ...
                // other clients.
                la(n, e, o || null), fa(n, e), function(t, e) {
                    W(W(t).An).ee(e);
                }(n.localStore, e)) : G(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , ga(n, s) ];
...
function Sa(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return Ca(n = W(t)), xa(n), !0 !== e || !0 === n.Wo ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , _a(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.Wo = !0, [ 4 /*yield*/ , Ns(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, a = o; s < a.length; s++) u = a[s], cs(n.remoteStore, u);
                return [ 3 /*break*/ , 7 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return s < a.length ? (u = a[s], c = void 0, (h = n.Mo.get(u)) && 0 !== h.length ? [ 4 /*yield*/ , go(n.localStore, Ae(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (d = l[f], p = n.Fo.get(d), [ 4 /*yield*/ , Ia(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , Io(n.localStore, u) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , go(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , na(n, ka(v), u, 
                /*current=*/ !1) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                return s = r.sent(), a = Pn.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , ga(n, s, a) ];
              ...
              case 6:
                return r.sent(), da(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function Na(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, a, u, c, h, f, l, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = Ca(t)).Wo) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;
              ...
              case 2:
                return u = p.sent(), [ 4 /*yield*/ , go(n.localStore, u) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , na(n, ka(u), c.targetId, 
                /*current=*/ !1) ];
              ...
              case 6:
                h = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.Mo.has(t) ? [ 4 /*yield*/ , wo(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
...
function Ca(t) {
    ...
    e.remoteStore.remoteSyncer.rejectListen = aa.bind(null, e), e.Oo.br = Bs.bind(null, e.eventManager), 
    e.Oo.zo = js.bind(null, e.eventManager), e;
}

function xa(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = ua.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = ca.bind(null, e), 
    e
    /**
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return u = r.sent(), [ 4 /*yield*/ , ga(t, u.In, 
                    /* remoteEvent */ void 0) ];
...
var La = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.k = $o(t.databaseInfo.databaseId), this.sharedClientState = this.Jo(t), 
        ...
        return ho(this.persistence, new uo, t.initialUser, this.k);
    ...
    return t(i, e), i.prototype.initialize = function(t) {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 3:
                    ...
                    return r.sent(), [ 4 /*yield*/ , xa(this.ta.syncEngine) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , Ts(this.ta.remoteStore) ];
        ...
        return new eo(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Xo(), Zo(), this.k, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.Jo = function(t) {
        return new zo;
    }, i;
}(La), Oa = /** @class */ function(e) {
    function i(t, n) {
        var r = this;
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.ta.syncEngine, this.sharedClientState instanceof Go ? (this.sharedClientState.syncEngine = {
                        mi: Ea.bind(null, i),
                        gi: Da.bind(null, i),
                        yi: Na.bind(null, i),
                        Tn: Aa.bind(null, i),
                    ...
                    return [ 4 /*yield*/ , this.persistence.sn((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , Sa(this.ta.syncEngine, t) ];
    ...
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return sa(n.syncEngine, t, 1 /* SharedClientState */);
        ...
        var e, n = $o(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Jo(e));
 ...
 */ var Va = /** @class */ function() {
                                    ...
                                    return s = r.sent(), a = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = $n(t, e.found.name), r = Yn(e.found.updateTime), i = new Yt({
                                                    mapValue: {
                                                ...
                                                var n = $n(t, e.missing), r = Yn(e.readTime);
    ...
    function t(t, e, n, r) {
        ...
        this.la = 5, this.ur = new ts(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.ur.Zi((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new Ua(this.datastore), (e = this.da(t)) && e.then((function(e) {
    ...
    i, o) {
        ...
        this.user = O.UNAUTHENTICATED, this.clientId = ut.A(), this.authCredentialListener = function() {
            return Promise.resolve();
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    ...
                                    n.Gr.add(3 /* CredentialChange */), [ 4 /*yield*/ , us(n) ];
                                  ...
                                  case 2:
                                    return r.sent(), n.Gr.delete(3 /* CredentialChange */), [ 4 /*yield*/ , as(n) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = ea.bind(null, e.syncEngine), 
                n.onUnlisten = ra.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function Za(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new J;
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function au(t) {
 ...
 */ var hu = /** @class */ function() {
    function t(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, iu("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    ...
    function t(t, e, n) {
        ...
        this._settingsFrozen = !1, t instanceof eu ? this._databaseId = t : (this._app = t, 
    ...
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new hu(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            if (!t) return new Z;
            switch (t.type) {
              case "gapi":
                var e = t.client;
 ...
 */
        return t = this, (e = nu.get(t)) && (U("ComponentProvider", "Removing Datastore"), 
        nu.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
 ...
 */ function lu(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        if ("string" == typeof r.mockUserToken) s = r.mockUserToken, a = O.MOCK_USER; else {
            ...
            if (!u) throw new Y(H.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
            a = new O(u);
        }
        t._authCredentials = new $(new X(s, a));
    }
}
 ...
 */ var du = /** @class */ function() {
    ...
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.isEmpty() ? null : new du(this.firestore, 
 ...
 */ function vu(t, n) {
    ...
    if (t = I(t), ru("collection", "path", n), t instanceof fu) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return su(o), new yu(t, /* converter= */ null, o);
    }
    if (!(t instanceof du || t instanceof yu)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return su(s), new yu(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function mu(t, e) {
    if (t = uu(t, fu), ru("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new Y(H.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new pu(t, 
    /* converter= */ null, 
    /**
...
function gu(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = ut.A()), ru("doc", "path", n), t instanceof fu) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return ou(o), new du(t, 
        /* converter= */ null, new Pt(o));
    }
    if (!(t instanceof du || t instanceof yu)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return ou(s), new du(t.firestore, t instanceof yu ? t.converter : null, new Pt(s));
}
 ...
 * Firestore database.
 */ function wu(t, e) {
    return t = I(t), e = I(e), (t instanceof du || t instanceof yu) && (e instanceof du || e instanceof yu) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function bu(t, e) {
    return t = I(t), e = I(e), t instanceof pu && e instanceof pu && t.firestore === e.firestore && Ne(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var Eu = /** @class */ function() {
    ...
    function n(t, n, r) {
        ...
        /**
             ...
             */
        return (i = e.call(this, t, n, r) || this).type = "firestore", i._queue = new Iu, 
...
function Nu(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new tu(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new ja(t._authCredentials, t._appCheckCredentials, t._queue, r);
}
 ...
 */ function Cu(t, e) {
    Uu(t = uu(t, _u));
    var n = Du(t), r = t._freezeSettings(), i = new Fa;
 ...
 */ function xu(t) {
    Uu(t = uu(t, _u));
    var e = Du(t), n = t._freezeSettings(), r = new Fa;
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , Ka(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Ga(t, e) ];
 ...
 */ function Ou(t) {
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return e = r.sent(), [ 4 /*yield*/ , Ya(t) ];

                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = W(t);
                            return e.Gr.delete(0 /* UserDisabled */), as(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (Du(t = uu(t, _u)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).Gr.add(0 /* UserDisabled */), [ 4 /*yield*/ , us(e) ];
...
function qu(t, e) {
    ...
    }(Du(t = uu(t, _u)), e).then((function(e) {
        return e ? new pu(t, null, e.query) : null;
    }));
}
...
/** A "context" object passed around while parsing user data. */ var Ju = /** @class */ function() {
    /**
    ...
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.k = n || $o(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.ja = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Ju({
            xa: t,
            methodName: e,
            Ka: n,
            path: bt.emptyPath(),
 ...
 * classes.
 */ function Zu(t) {
    var e = t._freezeSettings(), n = $o(t._databaseId);
    return new Xu(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function $u(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.ja(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    lc("Data must be an object, but it was:", s, r);
    var a, u, c = hc(r, s);
    if (o.merge) a = new It(s.fieldMask), u = s.fieldTransforms; else if (o.mergeFields) {
        ...
        a = new It(h), u = s.fieldTransforms.filter((function(t) {
            return a.covers(t.field);
        }));
    } else a = null, u = s.fieldTransforms;
    return new Wu(new Yt(c), a, u);
}
...
}(Gu), oc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).Wa = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new We(t.k, Me(t.k, this.Wa));
...
/** Parse update data from a list of field/value arguments. */ function ac(t, e, n, r, i, o) {
    ...
    for (var c = 0; c < o.length; c += 2) a.push(dc(e, o[c])), u.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = Yt.empty(), l = a.length - 1; l >= 0; --l) if (!mc(h, a[l])) {
        var d = a[l], p = u[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
    ...
    var m = new It(h);
    return new Hu(f, m, s.fieldTransforms);
}
 ...
 */ function uc(t, e, n, r) {
    return void 0 === r && (r = !1), cc(n, t.ja(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function cc(t, e) {
    ...
    return function(t, e) {
        ...
        if (!Yu(e.xa)) throw e.Ua(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.Ua("Unsupported field value: " + au(t));
    }(t, e);
}
...
function fc(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof lt || t instanceof zu || t instanceof Ku || t instanceof du || t instanceof Gu);
}
 ...
 */ function dc(t, e, n) {
    ...
    throw vc("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ function yc(t, n, r) {
    ...
    /* path= */ void 0, r);
    try {
        return (new (Bu.bind.apply(Bu, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
...
function vc(t, e, n, r, i) {
    ...
    u += ")"), new Y(H.INVALID_ARGUMENT, (a += ". ") + t + u)
 ...
 */ var gc = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "id", {
         ...
         */
        get: function() {
            return new du(this._firestore, this._converter, this._key);
        },
        enumerable: !1,
        configurable: !0
    }), 
 ...
 */
function bc(t, e) {
    return "string" == typeof e ? yc(t, e) : e instanceof Bu ? e._internalPath : e._delegate._internalPath;
}
...
var Cc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Zu(t.firestore), n = function(t, e, n, r, i, o, s) {
            var a;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new Y(H.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
...
var Pc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new pu(t.firestore, t.converter, De(t._query, this.Ya, this.Xa));
    }, n;
}(Dc);
 ...
 * @returns The created {@link Query}.
 */ function Oc(t) {
    return cu("limit", t), new Pc("limit", t, "F" /* First */)
    /**
...
var Mc = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.Za = n, i.tc = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Kc(t, this.type, this.Za, this.tc);
        return new pu(t.firestore, t.converter, function(t, e) {
...
function Vc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Mc("startAt", t, /*before=*/ !0);
}

function qc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Mc("startAfter", t, 
    /*before=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function Kc(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof gc) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], s = 0, a = ke(t); s < a.length; s++) {
            var u = a[s];
            if (u.field.isKeyField()) o.push(jt(e, r.key)); else {
                var c = r.data.field(u.field);
                if (Dt(c)) throw new Y(H.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + u.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var a = [], u = 0; u < i.length; u++) {
            ...
            if (s[u].field.isKeyField()) {
                ...
                if (!_e(t) && -1 !== c.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(gt.fromString(c));
                if (!Pt.isDocumentKey(h)) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new Pt(h);
                a.push(jt(e, f));
            } else {
                var l = uc(n, r, c);
...
function Gc(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        if ("" === n) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!_e(e) && -1 !== n.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(gt.fromString(n));
        if (!Pt.isDocumentKey(r)) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return jt(t, new Pt(r));
    }
    if (n instanceof du) return jt(t, n._key);
    throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + au(n) + ".");
}
 ...
 */ var Wc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new zu(kt(t.latitude), kt(t.longitude));
        ...
        z(Ir(n));
        var r = new eu(n.get(1), n.get(3)), i = new Pt(n.popFirst(5));
        return r.isEqual(e) || 
...
var Yc = /** @class */ function(e) {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = Xc(t, this._firestore), i = Hc(r.converter, e, n), o = $u(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Ze.none())), this;
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Bu ? ac(this._dataReader, "WriteBatch.update", s._key, e, n, r) : sc(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(o.toMutation(s._key, Ze.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        ...
        return this._mutations = this._mutations.concat(new pn(e._key, Ze.none())), this;
    }, 
    /**
 ...
 */ function Zc(t) {
    t = uu(t, du);
    var e = uu(t.firestore, _u);
    return Za(Du(e), t._key).then((function(n) {
        return lh(e, t, n);
    }));
}
 ...
 */ function th(t) {
    t = uu(t, du);
    var e = uu(t.firestore, _u), i = Du(e), o = new $c(e);
    return function(t, e) {
        var i = this, o = new J;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
 ...
 */ function nh(t) {
    t = uu(t, pu);
    var e = uu(t.firestore, _u), n = Du(e), r = new $c(e);
    return Ac(t._query), $a(n, t._query).then((function(n) {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return n = r.sent(), o = new Xs(e, n.zn), s = o.Po(n.documents), a = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(a.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return u = r.sent(), c = Ls(u, "Failed to execute query '" + e + " against cache"), 
...
function oh(t, e, n) {
    t = uu(t, du);
    var r = uu(t.firestore, _u), i = Hc(t.converter, e, n);
    return fh(r, [ $u(Zu(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Ze.none()) ]);
}

function sh(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = uu(t, du);
    var o = uu(t.firestore, _u), s = Zu(o);
    return fh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof Bu ? ac(s, "updateDoc", t._key, e, n, r) : sc(s, "updateDoc", t._key, e)).toMutation(t._key, Ze.exists(!0)) ]);
}
 ...
 */ function ah(t) {
    return fh(uu(t.firestore, _u), [ new pn(t._key, Ze.none()) ]);
}
 ...
 */ function uh(t, e) {
    var n = uu(t.firestore, _u), r = gu(t), i = Hc(t.converter, e);
    return fh(n, [ $u(Zu(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Ze.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function ch(t) {
    ...
    "object" != typeof s[c] || Tu(s[c]) || (u = s[c], c++);
    var h, f, l, d = {
    ...
    if (t instanceof du) f = uu(t.firestore, _u), l = be(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](lh(f, t, e));
        },
        error: s[c + 1],
        ...
        var y = uu(t, pu);
        f = uu(y.firestore, _u), l = y._query;
        var v = new $c(f);
        h = {
            next: function(t) {
    ...
    return function(t, e, i, o) {
        var s = this, a = new Va(o), u = new Gs(e, a, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
 ...
 */ function lh(t, e, n) {
    var r = n.docs.get(e._key), i = new $c(t);
 ...
 */ var dh, ph = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Xc(t, this._firestore), i = new $c(this._firestore);
    ...
    return t.prototype.get = function(t) {
        ...
        var r = Xc(t, this._firestore), i = Hc(r.converter, e, n), o = $u(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Bu ? ac(this._dataReader, "Transaction.update", s._key, e, n, r) : sc(this._dataReader, "Transaction.update", s._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new Ba(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
    }(Du(t = uu(t, _u)), (function(n) {
        return e(new ph(t, n));
    }));
}
 ...
 * writes.
 */ function Ih(t) {
    return Du(t = uu(t, _u)), new Jc(t, (function(e) {
        return fh(t, e);
    }))
    /**
 * Cloud Firestore
...
void 0 === dh && (dh = !0), F = i, o(new c("firestore", (function(t, e) {
