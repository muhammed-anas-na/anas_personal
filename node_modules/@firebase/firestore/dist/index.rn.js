    ...
    start(t, e) {
        ...
        setTimeout((() => {
            if (!this.auth) {
                ...
                F("FirebaseAuthCredentialsProvider", "Auth not yet detected"), i.resolve(), i = new G);
            }
        }), 0), r();
    }
    getToken() {
...
/** Transforms an array value via a union operation. */ class Ke extends Me {
    constructor(t) {
...
function pn(t) {
    ...
    return M("GRPC error has no .code"), Q.UNKNOWN;
    switch (t) {
      case mn.OK:
        return Q.OK;
...
// Visible for testing
const Gs = [ ...[ ...[ ...[ ...[ ks.store, xs.store, $s.store, Ms.store, Bs.store, Ns.store, qs.store, Us.store ], js.store ], Ls.store ], Ks.store ], Qs.store, Ws.store ], zs = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
...
class ki {
    ...
    ne(t) {
        return Fi(t).get(this.userId).next((t => t || new ks(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
    ...
    me(t) {
        ...
        F("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this._e = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                ei(t) ? F("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Ki(t);
            }
            await this.me(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Gi {
    ...
    collect(t, e) {
        ...
        Js.resolve(Si)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (F("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        Si) : this.Te(t, e)));
    }
    getCacheSize(t) {
...
class zi {
     ...
     */    Ae(t, e) {
        return function(t, e) {
            let n = !1;
            return Fi(t).Qt((s => xi(t, s, e).next((t => (t && (n = !0), Js.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
 ...
 */ (t);
    ...
    ke(t) {
        let e = 0;
        return t.store(Ms.store).jt(((t, n) => {
            e += Ni(n);
        })).next((() => {
            const n = new Ls(e);
     ...
     */    xe(t) {
        const e = t.store(Us.store), n = t.store(Ms.store);
...
class Kr {
     ...
     */    static Os(t, e, n) {
        ...
        r && (i = new W(s.error.code, s.error.message))), r ? new Kr(t, e, s.state, i) : (M("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Fs() {
        const t = {
...
class jr {
     ...
     */    static Os(t, e) {
        ...
        i && (s = new W(n.error.code, n.error.message))), i ? new jr(t, n.state, s) : (M("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Fs() {
        const t = {
 ...
 */ class Qr {
     ...
     */    static Os(t, e) {
        ...
        return s ? new Qr(t, i) : (M("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Wr {
     ...
     */    static Os(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Wr(e.clientId, e.onlineState) : (M("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ (this.persistenceKey), this.Ks = this.Ks.insert(this.Bs, new Gr), this.Gs = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    qs(t) {
        ...
        if (e.storageArea === this.storage) {
            if (F("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.Qs) return void M("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            ...
            o.listenOnce(A.COMPLETE, (() => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case R.TIMEOUT:
                        F("Connection", 'RPC "' + t + '" timed out'), r(new W(Q.DEADLINE_EXCEEDED, "Request time out"));
                        break;
...
class ro {
     ...
     */    Er(t) {
        return e => {
            this.Fe.enqueueAndForget((() => this.rr === t ? e() : (F("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
...
class uo {
    ...
    qr(t) {
        ...
        this.Lr ? (M(e), this.Lr = !1) : F("OnlineStateTracker", e);
    }
    jr() {
    ...
    e, n, s, i) {
        ...
        this.zr = [], this.Hr = i, this.Hr.Ei((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                To(this) && (F("RemoteStore", "Restarting streams for network reachability change."), 
...
function Do(t) {
    return To(t) && !Mo(t).hr() && t.Qr.length > 0;
}
 ...
 */ function Mo(t) {
    ...
    t.Zr = function(t, e, n) {
        ...
        await vo(t)) : (await t.Zr.stop(), t.Qr.length > 0 && (F("RemoteStore", `Stopping write stream with ${t.Qr.length} pending writes`), 
        t.Qr = []));
    }))), t.Zr;
}
 ...
 */ function Bo(t, e) {
    if (M("AsyncQueue", `${e}: ${t}`), ei(t)) return new W(Q.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class aa {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.Oo = {}, this.Fo = new Ji((t => De(t)), Se), 
        this.Mo = new Map, 
        /**
        ...
        this.jo = new Map, this.Qo = Mi.re(), this.onlineState = "Unknown" /* Unknown */ , 
 ...
 */ class Ka {
    ...
    terminate() {
        return async function(t) {
            const e = j(t);
            F("RemoteStore", "RemoteStore shutting down."), e.Gr.add(5 /* Shutdown */), await fo(e), 
            e.Hr.shutdown(), 
 ...
 */ class Lu {
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new Mu(this._firestore, this._userDataWriter, n.key, n, new Ou(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new Mu(t._firestore, t._userDataWriter, n.doc.key, n.doc, new Ou(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new Mu(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Ou(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
 ...
 */ function vh(t, e, n) {
    ...
    return new Fu(t, i, e._key, s, new Ou(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class Vh extends class {
     ...
     */    get(t) {
        ...
        return super.get(t).then((t => new Fu(this._firestore, n, e._key, t._document, new Ou(
        /* hasPendingWrites= */ !1, 
